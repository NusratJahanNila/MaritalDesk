...
const MarriageCertificate = ({
  ...
  return (
    <div className='py-4'>
      <div className='max-w-4xl mx-auto my-8 bg-white shadow-2xl border-4 border-[#0a7d2c] rounded-sm font-serif overflow-hidden'>
          ...
          <div className='space-y-7 text-lg leading-relaxed'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-[auto,1fr] gap-x-4 gap-y-5'>
              ...
              <div className='mt-4'>
                ...
                <br />
                Daughter of <span className='font-bold'>
                  {brideFatherName}
                </span>{' '}
                and <span className='font-bold'>{brideMotherName}</span>
                <br />
                of {brideAddress}
                <br />
            ...
            <div className='mt-10 pt-6 border-t border-gray-300'>
              <p>
                ...
                and registration was solemnized on{' '}
                <strong>{registrationDate}</strong>
              </p>
              <p className='mt-4'>
                in my office and registered in{' '}
                <strong>Volume No. {volumeNo}</strong>, Book No.{' '}
                <strong>{bookNo}</strong>, Serial No.{' '}
              ...
              <div className='text-center'>
                ...
                <div className='mt-10'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Muslim Marriage & Divorce Registrar
                  </p>
                  <p className='text-sm text-gray-600'>
