...
const Payment = () => {
    ...
    const calculateTotal = () => {
        return paymentDetails.registryFee + paymentDetails.kaziFee + paymentDetails.serviceFee + paymentDetails.charge;
    };
    ...
    const handlePayment = () => {
        ...
        setTimeout(() => {
            ...
            // Here you will integrate with your Stripe payment
        ...
        <div className="max-w-6xl mx-auto p-3 md:p-5">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-green-700 to-green-800 p-6 text-white">
                    <h1 className="text-2xl md:text-3xl font-bold">Complete Your Marriage Application Payment</h1>
                    <p className="text-green-100 mt-2">Secure payment gateway • Instant confirmation</p>
                </div>
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-white">Payment Summary</h2>
                            <button 
                                ...
                                {[
                                    ...
                                    <div key={index} className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                                        <div className="flex items-center gap-3">
                                            <div className={`w-10 h-10 rounded-full bg-${item.color}-100 dark:bg-${item.color}-900/30 flex items-center justify-center`}>
                                                {item.icon}
                                            </div>
                                            <div>
                                        ...
                                        <span className="font-bold text-gray-800 dark:text-white">৳{item.amount}</span>
                                    </div>
                                ))}
                            </div>
                        )}
                        ...
                        <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6">
                            <div className="flex justify-between items-center">
                                <div>
                                    <h3 className="text-lg font-bold text-gray-800 dark:text-white">Total Amount</h3>
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">Inclusive of all charges</p>
                                </div>
                                <div className="text-right">
                                    <div className="text-3xl font-bold text-green-700 dark:text-green-400">৳{calculateTotal()}</div>
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">BDT</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-gray-800 dark:text-white">Stripe Payment Gateway</h3>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <div className="px-3 py-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                <span className="font-medium text-gray-700 dark:text-gray-300">Visa</span>
                            </div>
                            <div className="px-3 py-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                <span className="font-medium text-gray-700 dark:text-gray-300">MasterCard</span>
                            </div>
                            <div className="px-3 py-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                <span className="font-medium text-gray-700 dark:text-gray-300">American Express</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <button
                            ...
                            className={`flex-1 btn ${isProcessing ? 'bg-gray-400' : 'bg-green-700 hover:bg-green-800 dark:bg-green-600 dark:hover:bg-green-700'} text-white font-bold py-4 rounded-xl transition-all duration-300 ${!isProcessing && 'hover:scale-[1.02]'}`}
                        >
                            {isProcessing ? (
                    ...
                    <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h4 className="font-medium text-gray-800 dark:text-gray-200">Secure Payment</h4>
                        </div>
